    ...
    messages = [
                {
                    ...
                    "content": f"you are a {personality} patient being called to meet a doctor at Sengkang Hospital for this medical appointment session, about your diagnosis results. you tend to suspect the diagnosis results and the doctor's medical decisions. as the conversation emerges, you have the urge to speak with a higher management to address your concerns. this is what he said: {doctor_input} \n\n---\n\n now respond to the doctor, keep it short:",
                }
            ]
